...
```{r}
norm.genes <- readRDS(file = "counts_normalized_Sid_Symbiont_B.rds")
...
```{r}
counts.transformed.vst <- readRDS(file = "counts_vst.BlindFalse_Sid_Symbiont_B.rds")
```
...
```{r}
de.genes.LO_LC <- readRDS(file = "Sid_Symbiont_Breviolum_LO_LC_pval.05.rds")
...
```{r}
de.genes.OO_LO <- readRDS(file = "Sid_Symbiont_Breviolum_OO_LO_pval.05.rds")
...
```{r}
de.genes.LO_RO <- readRDS(file = "Sid_Symbiont_Breviolum_LO_RO_pval.05.rds")
...
```{r}
de.genes.OO_OC <- readRDS(file = "Sid_Symbiont_Breviolum_OO_OC_pval.05.rds")
...
```{r}
de.genes.OO_RO <- readRDS(file = "Sid_Symbiont_Breviolum_OO_RO_pval.05.rds")
...
```{r}
de.genes.RO_RC <- readRDS(file = "Sid_Symbiont_Breviolum_RO_RC_pval.05.rds")
...
```{r}
de.genes.OC_LC <- readRDS(file = "Sid_Symbiont_Breviolum_OC_LC_pval.05.rds")
...
```{r}
de.genes.OC_RC <- readRDS(file = "Sid_Symbiont_Breviolum_OC_RC_pval.05.rds")
...
```{r}
de.genes.LC_RC <- readRDS(file = "Sid_Symbiont_Breviolum_LC_RC_pval.05.rds")
...
```{r}
# save plot
#pdf("Sid_Symbiont_B_PCA_total-exp_group.pdf")
...
plot <- DESeq2::plotPCA(counts_de, returnData = TRUE, intgroup = c("group")) %>% 
      ...
      xlab(paste0("PC1: ",percentVar[1],"% variance")) +
      ylab(paste0("PC2: ",percentVar[2],"% variance")) +
      labs(title = "Lagoon-Ojo vs. Lagoon-Control (50 genes)") +
      labs(color = "Origin.Destination", fill = "Origin.Destination") +
      theme_cowplot()
...
```{r}
# save plot
pdf("Sid_Symbiont_B_PCA_LO_LC_all-indiv.pdf")
...
```{r}
# save plot
#pdf("Sid_Symbiont_B_PCA_LO_LC_subset.pdf")
...
plot <- DESeq2::plotPCA(counts_de, returnData = TRUE, intgroup = c("group")) %>% 
      ...
      xlab(paste0("PC1: ",percentVar[1],"% variance")) +
      ylab(paste0("PC2: ",percentVar[2],"% variance")) +
      labs(title = "Ojo-Ojo vs. Ojo-Control (66 genes)") +
      labs(color = "Origin.Destination", fill = "Origin.Destination") +
      theme_cowplot()
...
```{r}
# save plot
pdf("Sid_Symbiont_B_PCA_OO_OC_all-indiv.pdf")
...
# select relevant sample columns for the given pairwise comparison
colnames(counts.transformed.vst)
counts_de <- counts.transformed.vst[,c(12:22)]
...
```{r}
# save plot
#pdf("Sid_Symbiont_B_PCA_OO_OC_subset.pdf")
...
plot <- DESeq2::plotPCA(counts_de, returnData = TRUE, intgroup = c("group")) %>% 
      ...
      xlab(paste0("PC1: ",percentVar[1],"% variance")) +
      ylab(paste0("PC2: ",percentVar[2],"% variance")) +
      labs(title = "Ojo-Control vs. Lagoon-Control (112 genes)") +
      labs(color = "Origin.Destination", fill = "Origin.Destination") +
      theme_cowplot()
...
```{r}
# save plot
pdf("Sid_Symbiont_B_PCA_OC_LC_all-indiv.pdf")
...
# select relevant sample columns for the given pairwise comparison
colnames(counts.transformed.vst)
counts_de <- counts.transformed.vst[,c(1,3,5,7,8,10,12,14,16,18,20)]
...
```{r}
# save plot
#pdf("Sid_Symbiont_B_PCA_OC_LC_subset.pdf")
...
plot <- DESeq2::plotPCA(counts_de, returnData = TRUE, intgroup = c("group")) %>% 
      ...
      xlab(paste0("PC1: ",percentVar[1],"% variance")) +
      ylab(paste0("PC2: ",percentVar[2],"% variance")) +
      labs(title = "Ojo-Ojo vs. Lagoon-Ojo (81 genes)") +
      labs(color = "Origin.Destination", fill = "Origin.Destination") +
      theme_cowplot()
...
```{r}
# save plot
pdf("Sid_Symbiont_B_PCA_OO_LO_all-indiv.pdf")
...
# select relevant sample columns for the given pairwise comparison
colnames(counts.transformed.vst)
counts_de <- counts.transformed.vst[,c(2,4,6,9,11,13,15,17,19,21,22)]
...
```{r}
# save plot
#pdf("Sid_Symbiont_B_PCA_OO_LO_subset.pdf")
...
plot <- DESeq2::plotPCA(counts_de, returnData = TRUE, intgroup = c("group")) %>% 
      ...
      xlab(paste0("PC1: ",percentVar[1],"% variance")) +
      ylab(paste0("PC2: ",percentVar[2],"% variance")) +
      labs(title = "Reef-Ojo vs. Reef-Control (358 genes)") +
      labs(color = "Origin.Destination", fill = "Origin.Destination") +
      theme_cowplot()
...
```{r}
# save plot
pdf("Sid_Symbiont_B_PCA_RO_RC_all-indiv.pdf")
...
# select relevant sample columns for the given pairwise comparison
colnames(counts.transformed.vst)
counts_de <- counts.transformed.vst[,c(23:36)]
...
```{r}
# save plot
#pdf("Sid_Symbiont_B_PCA_RO_RC_subset.pdf")
...
plot <- DESeq2::plotPCA(counts_de, returnData = TRUE, intgroup = c("group")) %>% 
      ...
      xlab(paste0("PC1: ",percentVar[1],"% variance")) +
      ylab(paste0("PC2: ",percentVar[2],"% variance")) +
      labs(title = "Lagoon-Ojo vs. Reef-Ojo (6020 genes)") +
      labs(color = "Origin.Destination", fill = "Origin.Destination") +
      theme_cowplot()
...
```{r}
# save plot
pdf("Sid_Symbiont_B_PCA_LO_RO_all-indiv.pdf")
...
# select relevant sample columns for the given pairwise comparison
colnames(counts.transformed.vst)
counts_de <- counts.transformed.vst[,c(2,4,6,9,11,24,26,28,31,33,34)]
...
```{r}
# save plot
#pdf("Sid_Symbiont_B_PCA_LO_RO_subset.pdf")
