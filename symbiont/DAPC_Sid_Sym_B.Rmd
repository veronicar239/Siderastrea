...
# Symbionts - *Breviolum*
### from coral *Siderastrea siderea*
...
From here, we can narrow the search by specifying the number of PC to try with n.pca and centering it around 16-20, and doing 100(0) replicates each.

***NB! This will take a long time ! (for 100, 1000 replicates)***
```{r}
xval2 <- xvalDapc(dat, meta$group, n.pca.max = 300, n.da = NULL, training.set = 0.9, result = "groupMean", center = TRUE, scale = FALSE, n.pca = 14:21, n.rep = 100, xval.plot = TRUE)
```
...
- var (proportion of conserved variance): 0.941
...
```{r}
dp2 = dapc(dat, meta$group, n.pca = 19, n.da = 5)
dp2
```
...
```{r}
# save plot
pdf("Sid_Sym_B_DAPC_scatter.pdf")
...
```{r}
# save plot
pdf("Sid_Sym_B_DAPC_density.pdf")
