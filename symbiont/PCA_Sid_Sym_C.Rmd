...
```{r}
norm.genes <- readRDS(file = "counts_normalized_Sid_Symbiont_C.rds")
...
```{r}
counts.transformed.vst <- readRDS(file = "counts_vst.BlindFalse_Sid_Symbiont_C.rds")
```
...
```{r}
de.genes.LO_LC <- readRDS(file = "Sid_Symbiont_LO_LC_pval.05.rds")
...
```{r}
de.genes.OO_LO <- readRDS(file = "Sid_Symbiont_OO_LO_pval.05.rds")
...
```{r}
de.genes.LO_RO <- readRDS(file = "Sid_Symbiont_LO_RO_pval.05.rds")
...
```{r}
de.genes.OO_OC <- readRDS(file = "Sid_Symbiont_OO_OC_pval.05.rds")
...
```{r}
de.genes.OO_RO <- readRDS(file = "Sid_Symbiont_OO_RO_pval.05.rds")
...
```{r}
# save plot
#pdf("Sid_Symbiont_C_PCA_total-exp_group.pdf")
...
plot <- DESeq2::plotPCA(counts_de, returnData = TRUE, intgroup = c("group")) %>% 
      ...
      xlab(paste0("PC1: ",percentVar[1],"% variance")) +
      ylab(paste0("PC2: ",percentVar[2],"% variance")) +
      labs(title = "Lagoon-Ojo vs. Lagoon-Control (107 genes)") +
      labs(color = "Origin.Destination", fill = "Origin.Destination") +
      theme_cowplot()
...
```{r}
# save plot
pdf("Sid_Symbiont_C_PCA_LO_LC_all-indiv.pdf")
...
counts_de <- counts.transformed.vst[,c(1:10)]
...
```{r}
# save plot
#pdf("Sid_Symbiont_C_PCA_LO_LC_subset.pdf")
...
plot <- DESeq2::plotPCA(counts_de, returnData = TRUE, intgroup = c("group")) %>% 
      ...
      xlab(paste0("PC1: ",percentVar[1],"% variance")) +
      ylab(paste0("PC2: ",percentVar[2],"% variance")) +
      labs(title = "Ojo-Ojo vs. Ojo-Control (146 genes)") +
      labs(color = "Origin.Destination", fill = "Origin.Destination") +
      theme_cowplot()
...
```{r}
# save plot
pdf("Sid_Symbiont_C_PCA_OO_OC_all-indiv.pdf")
...
# select relevant sample columns for the given pairwise comparison
colnames(counts.transformed.vst)
counts_de <- counts.transformed.vst[,c(11:19)]
...
```{r}
# save plot
#pdf("Sid_Symbiont_C_PCA_OO_OC_subset.pdf")
...
plot <- DESeq2::plotPCA(counts_de, returnData = TRUE, intgroup = c("group")) %>% 
      ...
      xlab(paste0("PC1: ",percentVar[1],"% variance")) +
      ylab(paste0("PC2: ",percentVar[2],"% variance")) +
      labs(title = "Ojo-Control vs. Lagoon-Control (237 genes)") +
      labs(color = "Origin.Destination", fill = "Origin.Destination") +
      theme_cowplot()
...
```{r}
# save plot
pdf("Sid_Symbiont_C_PCA_OC_LC_all-indiv.pdf")
...
# select relevant sample columns for the given pairwise comparison
colnames(counts.transformed.vst)
counts_de <- counts.transformed.vst[,c(1,3,4,6,7,9,12,14,17)]
...
```{r}
# save plot
#pdf("Sid_Symbiont_C_PCA_OC_LC_subset.pdf")
...
plot <- DESeq2::plotPCA(counts_de, returnData = TRUE, intgroup = c("group")) %>% 
      ...
      xlab(paste0("PC1: ",percentVar[1],"% variance")) +
      ylab(paste0("PC2: ",percentVar[2],"% variance")) +
      labs(title = "Ojo-Ojo vs. Lagoon-Ojo (464 genes)") +
      labs(color = "Origin.Destination", fill = "Origin.Destination") +
      theme_cowplot()
...
```{r}
# save plot
pdf("Sid_Symbiont_C_PCA_OO_LO_all-indiv.pdf")
...
# select relevant sample columns for the given pairwise comparison
colnames(counts.transformed.vst)
counts_de <- counts.transformed.vst[,c(2,5,8,10,11,13,15,16,18,19)]
...
```{r}
# save plot
#pdf("Sid_Symbiont_C_PCA_OO_LO_subset.pdf")
