...
saveRDS(vsdBlindFalse, file = "counts_vst.BlindFalse_Sid_Symbiont_C.rds")

# later, after you already created the file, can load the existing file:
#vsdBlindFalse <- readRDS("counts_vst.BlindFalse_Sid_Symbiont_C.rds")
```
...
saveRDS(normalized_counts, file = "counts_normalized_Sid_Symbiont_C.rds")
...
write.csv(normalized_counts, "counts_normalized_Sid_Symbiont_C.csv", row.names = F)
```
