...
```{r}
xval2 <- xvalDapc(dat, meta$group, n.pca.max = 300, n.da = NULL, training.set = 0.9, result = "groupMean", center = TRUE, scale = FALSE, n.pca = 10:15, n.rep = 100, xval.plot = TRUE)
```
...
- var (proportion of conserved variance): 0.862
...
```{r}
dp2 = dapc(dat, meta$group, n.pca = 11, n.da = 5)
dp2
```
...
```{r}
# save plot
pdf("Sid_Sym_C_DAPC_scatter.pdf")
...
```{r}
# save plot
pdf("Sid_Sym_C_DAPC_density.pdf")
