...
Removed additional outlier that was identified through below data exploration and evaluation:
- smallest number of raw counts
- identified as outlier in cluster dendrogram 
- identified as outlier in PCA
- very small sizefactor (0.06066512) 
- very high proportion of null counts (73%)
```{r}
